...
if __name__ == '__main__':
    ...
    file_loc = r'/home/manuel/Documents/AI/data_files'
    model_var_loc = r'/home/manuel/Documents/AI/main/model_vars'
    ...
    target_dir = r'/home/manuel/Documents/AI/data_files'
    # target_dir = r'/home/manuel/Documents/Pred/final_inputs'
    # fasta_dir = r'/home/manuel/Documents/Pred/fasta'
    fasta_dir = r'/home/manuel/Documents/AUTOMATE/temp'
    targets = [f.split('_')[0] for f in os.listdir(target_dir) if
               'final_input' in f]

    for target in targets:
        fasta = get_fasta_seq(fasta_dir, target)

        # Predict desired protein chain and create structure matrix for NERF
        structure_data, pred_theta, pred_tau = predict(
            fr'{target_dir}/{target}_final_input.npy',
